                              ...
                              {% if getBenchmark %}
                                  ...
                                  <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ item.site }}</td>
                                        <td>{{ item.est_start_date|date:"SHORT_DATE_FORMAT" }}</td>
                                        <td>{{ item.est_end_date|date:"SHORT_DATE_FORMAT" }}</td>
                                        <td>{{ item.budget }}</td>
                              ...
                              {% if getBenchmark %}
                                  ...
                                  <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ item.est_start_date|date:"SHORT_DATE_FORMAT"}}</td>
                                        <td>{{ item.est_end_date|date:"SHORT_DATE_FORMAT"}}</td>
                                        <td>{{ item.actual_start_date|date:"SHORT_DATE_FORMAT"}}</td>
                                        <td>{{ item.actual_end_date|date:"SHORT_DATE_FORMAT"}}</td>
                                        <td>{{ item.budget}}</td>
                                        <td>{{ item.cost}}</td>

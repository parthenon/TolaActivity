...
class Documentation(models.Model):
    name = models.CharField(_("Record name"), max_length=135, blank=True, null=True)
    url = models.CharField(_("Link to file or folder"), blank=True, null=True, max_length=135)
